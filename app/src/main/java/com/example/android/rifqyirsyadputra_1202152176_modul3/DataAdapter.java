...
/**
 * Created by Rifqy on 25/02/2018.
 */
...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.WordViewHolder>   {
    ...
    public DataAdapter(Context context, LinkedList<String> TitleList, LinkedList<String> SubTitleList, LinkedList<Integer> BackgroundList) {
        ...
        public class WordViewHolder extends RecyclerView.ViewHolder {
            ...
            public WordViewHolder(View itemView, DataAdapter adapter) {
                super(itemView);
